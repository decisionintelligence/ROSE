...
for target_points in 336 720
do
    # for target_points in 96
    ...
    do
        ...
        --one_channel 0\
        --freeze_embedding $freeze_embedding >logs/LongForecasting/$model_type/$dset/$model_type'_512pretrain_'$dset'_cw'$context_points'_tw'$target_points'_patch'$patch_len'stride'$stride'_ne'$n_embedding'_'$finetune'_epoch'$n_epochs_finetune'_finetune_percentage'$finetune_percentage'_freeze_embedding'$freeze_embedding.log 
    done
done